...
#ALL Pgplot functionalities have been commented out! Convert to matplotlib in future?
#import Pgplot
...
class pfd:
    ...
    def plot_sumprof(self, device='/xwin'):
        ...
        #Pgplot.plotxy(normprof, labx="Phase Bins", laby="Normalized Flux",device=device)
    ...
    def greyscale(self, array2d, **kwargs):
        ...
        plt.figure()
        plt.imshow(array2d,cmap="binary") #choose cmap between Greys or binary or gist_yarg
        plt.show()
    ...
    def plot_chi2_vs_sub(self, device='/xwin'):
        ...
        # Now plot it
        #Pgplot.plotxy(chis, labx="Subband Number", laby="Reduced-\gx\u2\d",rangey=[0.0, max(chis)*1.1], device=device)
        return chis
